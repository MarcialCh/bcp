...
def main():
        ...
        for budget in budgets:
            ...
            if task == 'offline_bcp':
                ...
                winners, current_gain, trace = greedy_allocation(X_all=X_all, 
                                                                ...
                                                                costs=costs, 
                                                                budget=budget, task_type='image_classification')

            if task == 'offline_lz':
                winners, current_gain, trace = th_greedy_allocation(X_all=X_all, 
                                                                    init_indices=list(init_indices), 
                                                                    costs=costs, budget=budget, epsilon=epsilon, task_type='image_classification')
    ...
    for budget, acc, score in zip(budgets, all_results):
