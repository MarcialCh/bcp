...
def main():
    ...
    X_all = load_poi_coordinates('/data/usrs/yyr/cc/pricing/datasets/lixiaF_data.csv')
    ...
    budgets = list(range(1000, 1001, 100))
    ...
    for budget in budgets:
        ...
        write_file = open('/data/usrs/yyr/cc/pricing/crowdsensing/lixia' + "/" + str(task) + "_" + str(epsilon) + "_" + str(budget), 'w')
